...
export function Certificates() {
  const certificates = [
    ...
    },
    {
      ...
      issuer: 'freeCodeCamp',
      date: 'November 2025',
      description: 'Advanced certification in React.js covering hooks, state management, component lifecycle, and building full-scale applications.',
      category: 'Frontend',
      link: '#',
    ...
    },
    {
      ...
      issuer: 'freeCodeCamp',
      date: 'October 2025',
      description: 'In-depth study of algorithmic thinking, ES6 features, regular expressions, debugging, and object-oriented programming in JavaScript.',
    ...
    },
    {
      ...
      issuer: 'freeCodeCamp',
      date: 'September 2025',
      description: 'Mastered responsive web design techniques using CSS Flexbox, Grid, and media queries. Built multiple responsive projects.',
      category: 'Web Design',
      link: '#',
      image: 'https://images.unsplash.com/photo-1747576686252-ef7fbbde3829?w=800&q=80',
    },
